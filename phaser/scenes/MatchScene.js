  ...
  getProfile() {
    ...
    if (w < 1020) {
      return {
        ...
        handSidePadding: Math.max(62, w * 0.085),
        handAngle: 12,
        handAngleStep: 3.4,
        handLiftStep: 2.2,
        handMinSpread: 92,
    ...
    if (w < 1320) {
      return {
        ...
        handShelfRatio: 0.82,
        handBaseY: this.scale.height - 148,
        handSidePadding: Math.max(84, w * 0.105),
        handAngle: 14,
        handAngleStep: 3.8,
        handLiftStep: 3,
        handMinSpread: 108,
    ...
    if (w < 1680) {
      return {
        ...
        handBaseY: this.scale.height - 164,
        handSidePadding: Math.max(96, w * 0.108),
        handAngle: 14,
        handAngleStep: 3.6,
        handLiftStep: 3.6,
        handMinSpread: 124,
    ...
    return {
      ...
      handBaseY: this.scale.height - 176,
      handSidePadding: Math.max(118, w * 0.112),
      handAngle: 12,
      handAngleStep: 3.1,
      handLiftStep: 3.4,
      handMinSpread: 134,
  ...
  syncHand(cards) {
    ...
    cards.forEach((card, index) => {
      ...
      const target = {
        ...
        depth: fan.depth + (discardMode ? 12 : 0),
      };

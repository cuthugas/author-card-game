  ...
  getProfile() {
    ...
    if (w < 1020) {
      return {
        ...
        handShelfRatio: 0.83,
        handBaseY: this.scale.height - 112,
        handSidePadding: Math.max(78, w * 0.11),
        handAngle: 12,
        handAngleStep: 3.4,
        handLiftStep: 2.2,
        handMinSpread: 72,
    ...
    if (w < 1320) {
      return {
        ...
        handSidePadding: Math.max(108, w * 0.13),
        handAngle: 14,
        handAngleStep: 3.8,
        handLiftStep: 3,
        handMinSpread: 84,
    ...
    if (w < 1680) {
      return {
        ...
        handBaseY: this.scale.height - 136,
        handSidePadding: Math.max(124, w * 0.135),
        handAngle: 14,
        handAngleStep: 3.6,
        handLiftStep: 3.6,
        handMinSpread: 96,
    ...
    return {
      ...
      handBaseY: this.scale.height - 144,
      handSidePadding: Math.max(152, w * 0.145),
      handAngle: 12,
      handAngleStep: 3.1,
      handLiftStep: 3.4,
      handMinSpread: 104,
